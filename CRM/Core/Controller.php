...
class CRM_Core_Controller extends HTML_QuickForm_Controller {
  ...
  public function fini() {
    throw new \CRM_Core_Exception("CRM_Core_Controller::fini() - This function appears to be never used. What's up with that?");

    // This function does not appear to be used anywhere. However, if it is actually needed, try:
    //
    // \Civi::service('form_state')->save("_{$name}_container");
    // \Civi::service('form_state')->save("CiviCRM_{$this->_scope}");
  }
