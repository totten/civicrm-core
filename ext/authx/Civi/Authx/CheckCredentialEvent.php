...
/**
 * CheckCredentialEvent examines a credential and (if it validly represents
 * a user-principal) then it reports the principal.
 */
class CheckCredentialEvent extends \Civi\Core\Event\GenericHookEvent {
  ...
  public function __construct(string $cred) {
    [$this->credFmt, $this->credValue] = explode(' ', $cred, 2);
  }
