 ...
 * @group headless
 */
class TranslationTest extends UnitTestCase implements HookInterface {
  ...
  public function getCreateBadExamples() {
    ...
    $es['badTable'] = [
      ...
      '/non-existent or non-translatable table/',
    ];
  ...
  public function testGetFields() {
    $fields = \Civi\Api4\Translation::getFields()->setLoadOptions(TRUE)->execute()->indexBy('name')->getArrayCopy();
    $this->assertTrue(isset($fields['entity_table']['options']['civicrm_event']));
    $this->assertTrue(isset($fields['entity_field']['options']['description']));
  }
  ...
  public function hook_civicrm_translateFields(&$fields) {
