...
class CRM_Mailing_TokensTest extends \CiviUnitTestCase {
  ...
  public function getExampleTokens() {
    ...
    $cases[] = array('text/plain', 'To unsubscribe: {action.unsubscribe}!', ';To unsubscribe: u\.123\.456\.abcd1234@EXAMPLE\.ORG!;');
    $cases[] = array('text/plain', 'Track open: {action.trackOpenUrl}!', ";Track open: .*extern/open.php\?q=\d+;");
    $cases[] = array('text/html', 'Track open: {action.trackOpenHtml}!', ";Track open: <img src=\".*extern/open.php\?q=\d+\";");
