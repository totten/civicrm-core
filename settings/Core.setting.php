...
return array(
  ...
  'require_rest_site_key' => array(
    'group_name' => 'CiviCRM Preferences',
    'group' => 'core',
    'name' => 'require_rest_site_key',
    'type' => 'Boolean',
    'quick_form_type' => 'YesNo',
    'default' => TRUE,
    'html_type' => 'radio',
    'add' => '4.7',
    'title' => 'Require that REST API calls include the CiviCRM site key?',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => ts('If enabled, REST API calls must include the site key as well as the user\'s API key. If disabled, REST API calls only require the user\'s API key.'),
    'help_text' => NULL,
  ),
