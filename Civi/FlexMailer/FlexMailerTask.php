...
class FlexMailerTask {
   ...
   *
   * Within CiviMail, we have two competing data-structures to chose from when
   * representing a mail message:
   *
   *  - Mail_mime - From PEAR. This is generally better documented,
   *    more discoverable, but it's only been used internally.
   *  - $mailParams - From Hook::alterMailParams. This is quirky, but
   *    it's been publicly supported through our hooks.
   *
   * Flipped a coin and decided to stick with $mailParams.
   *
   * @var array|NULL
